...
@php
    ...
    // Gestion de old() après une erreur de validation
...
<div class="flex gap-8">
    ...
    <div class="w-[300px] bg-white rounded-2xl shadow p-6 text-center">
        ...
        <div class="mt-6 text-left text-sm space-y-4">
            ...
            <div class="border-b border-gray-200 pb-2 break-all">
                <div class="flex items-center gap-3">
                    <!-- Email -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-cyan-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="flex-1 bg-white rounded-2xl shadow p-10">
        <h1 class="text-2xl font-semibold mb-8">Modifier le profil</h1>
        ...
        <form method="POST" action="{{ route('chef.settings.update') }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="prenom" value="{{ old('prenom', $user->prenom) }}" class="w-full mt-1 border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-400">
                </div>
                ...
                <div class="col-span-2">
                    <label class="text-sm text-gray-500">Numéro de téléphone</label>
                    <div class="flex mt-1 items-center">
                        <div class="relative w-40">
                            ...
                            <div id="countryDropdown"
                                ...
                                <button type="button" onclick="selectCountry('+216','ic_tunisia_flag.png')" class="flex items-center gap-2 px-3 py-2 w-full hover:bg-gray-100">
                                    <img src="{{ asset('images/ic_tunisia_flag.png') }}" class="w-5 h-5"> +216
                                </button>

                                <button type="button" onclick="selectCountry('+39','ic_italy_flag.jpg')" class="flex items-center gap-2 px-3 py-2 w-full hover:bg-gray-100">
                                    <img src="{{ asset('images/ic_italy_flag.jpg') }}" class="w-5 h-5"> +39
                                </button>

                                <button type="button" onclick="selectCountry('+33','ic_france_flag.png')" class="flex items-center gap-2 px-3 py-2 w-full hover:bg-gray-100">
                                    <img src="{{ asset('images/ic_france_flag.png') }}" class="w-5 h-5"> +33
                                </button>

                                <button type="button" onclick="selectCountry('+1','ic_usa_flag.png')" class="flex items-center gap-2 px-3 py-2 w-full hover:bg-gray-100">
                                    <img src="{{ asset('images/ic_usa_flag.png') }}" class="w-5 h-5"> +1
                                </button>
                            </div>
                        </div>
                ...
                <!-- Mot de passe -->
                <div>
                    <label class="text-sm text-gray-500">Nouveau mot de passe</label>
            ...
            <div class="mt-10 text-center">
                <button type="submit" class="px-16 py-3 bg-cyan-500 text-white rounded-xl hover:bg-cyan-600 transition">Enregistrer</button>
            </div>
        </form>
