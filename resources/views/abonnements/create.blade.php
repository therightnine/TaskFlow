...
@section('title', 'Creer un abonnement')
@section('page-title', 'Creer un abonnement')

@section('content')
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-2xl shadow p-8">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Nouvelle offre d'abonnement</h1>
            <p class="text-sm text-gray-500 mt-1">Renseignez les details du plan. Vous pourrez le modifier plus tard.</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.abonnements.store') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea
                    ...
                    rows="5"
                    maxlength="500"
                    placeholder="Listez les avantages du plan..."
